<div>
    ...
    <div class="mb-4 flex flex-wrap items-end gap-3">
        ...
        @unless ($contactsMode)
            <div>
                <label class="mb-1.5 block text-xs font-semibold uppercase tracking-wide text-slate-500" for="f-state">{{ __('État') }}</label>
                <select id="f-state" wire:model.live="state"

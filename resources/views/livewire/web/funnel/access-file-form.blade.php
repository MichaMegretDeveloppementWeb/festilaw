<div>
    @if ($sent)
        <div class="funnel-success">
            ...
            <p class="funnel-success__text">If a Festilaw file exists for that email, we've just sent a secure link to access it. It can take a minute to arrive.</p>
    ...
    @else
        <form wire:submit="submit" class="funnel-form" novalidate>
            ...
            <button type="submit" class="btn btn--coral" wire:loading.attr="disabled" wire:target="submit">
                <span wire:loading.remove wire:target="submit">Email me my link</span>

<div>
    @if ($sent)
        <div class="funnel-success">
            ...
            <p class="funnel-success__text">{{ __('If a Festilaw project exists for that email, we\'ve just sent a secure link to access it. It can take a minute to arrive.') }}</p>

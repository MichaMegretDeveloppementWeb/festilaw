...
@section('title', 'Your file · Festilaw')
    ...
    <section class="my-file">
        <div class="my-file__inner">
            <header class="my-file__head">
                ...
                <h1 class="my-file__title">Your <span class="my-file__title-em">Creator Pack</span></h1>
                <p class="my-file__intro">Everything about your EU Responsible Person, in one place. Keep this link private · it's your secure access, no account needed.</p>
            </header>

            <div class="my-file__card">
                <span class="my-file__badge">Active</span>
                ...
                <dl class="my-file__meta">
                    ...
                    <div class="my-file__meta-row">
                        <dt>Plan</dt>
                        <dd>Creator Pack &middot; €333 / year</dd>
                    </div>
                    @if ($renewsAt)
                        <div class="my-file__meta-row">
                            <dt>Next renewal</dt>
                    ...
                    @endif
                    <div class="my-file__meta-row">
                        <dt>EU Responsible Person</dt>
                        <dd class="my-file__pending">Issued within 24&nbsp;h, emailed to you</dd>
                    </div>
                </dl>

                <h2 class="my-file__heading">Your documents</h2>
            ...
            <p class="my-file__support">Need anything? <a href="{{ route('contact', ['locale' => app()->getLocale()]) }}">Contact us</a> · real humans, happy to help.</p>
        </div>
    </section>
@endsection

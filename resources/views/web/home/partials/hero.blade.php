<section id="top" class="hero">
    <div class="hero__inner">
        <h1 class="hero__title">Your GPSR <span class="hero__title-em">Responsible Person</span></h1>
        <p class="hero__subtitle">Sell safely in the European market.</p>
        <p class="hero__lead">Festilaw becomes your official EU Responsible Person, with real support from entrepreneurs, for entrepreneurs.</p>

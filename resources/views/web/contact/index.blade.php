    ...
    <section class="contact">
        <div class="contact__inner">
            <div class="contact__intro">
                ...
                <h1 class="contact__title">Let's talk about your <span class="mk contact__title-mk">compliance</span>.</h1>
                ...
                <div class="contact__coords">
                    <a href="mailto:team@festilaw.com" class="contact__coord">
                        <span class="contact__coord-icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#EC5A57" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 6 9-6"/></svg>
                        </span>
                    ...
                    <div class="contact__coord contact__coord--soon">
                        <span class="contact__coord-icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0B1E45" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.4 8.4 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.4 8.4 0 0 1-3.8-.9L3 21l1.9-5.7a8.4 8.4 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.4 8.4 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8z"/></svg>
                        </span>
                        <span class="contact__coord-body">

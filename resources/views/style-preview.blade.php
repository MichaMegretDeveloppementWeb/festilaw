...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .section > .label { font-family: var(--sans); text-transform: uppercase; letter-spacing: 0.22em; font-size: 12px; font-weight: 600; color: var(--coral); margin-bottom: 18px; }
        .hint { font-size: 13px; color: var(--ink-soft); font-style: italic; }
        .reco { display: inline-block; font-family: var(--sans); font-style: normal; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #1a7f4b; background: #d9f0e2; padding: 2px 9px; border-radius: 999px; margin-left: 10px; vertical-align: middle; }
